...
import { FaSyncAlt, FaPlus, FaEye, FaEdit, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
      ...
      <div className="mt-[100px] mb-[28rem] md:ml-[250px] ml-12 p-4 w-[1250px]">
        ...
        <div className="flex justify-center items-center mt-4">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-md text-white transition bg-[#245AD2] hover:bg-[#1e4da1] disabled:opacity-50"
          >
            <FaChevronLeft className="text-sm" />
            Previous
          </button>
          <span className="mx-6 text-white font-semibold text-base">
            Page {currentPage} of {totalPages || 1}
          </span>
          <button
